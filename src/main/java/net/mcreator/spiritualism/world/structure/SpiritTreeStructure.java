...
package net.mcreator.spiritualism.world.structure;
...
public class SpiritTreeStructure extends SpiritualismModElements.ModElement {
	public SpiritTreeStructure(SpiritualismModElements instance) {
		super(instance, 4);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("spiritualism", "spiritree"));
						if (template == null)
							return false;
