...
import net.mcreator.spiritualism.procedures.SpiritBirchBlockDestroyedByPlayerProcedure;
...
public class SpiritBirchBlock extends SpiritualismModElements.ModElement {
	@ObjectHolder("spiritualism:spirit_birch")
	public static final Block block = null;
	public SpiritBirchBlock(SpiritualismModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 10f).lightValue(4).harvestLevel(1)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("spirit_birch");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blocks.BIRCH_LOG, (int) (1)));
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				SpiritBirchBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
